...
async def read_users(uuid_: uuid.UUID, db: DBSession = Depends(get_db)):
    try:
        return db.read_users(uuid_)
...
@router.put(
    ...
    description='Replaces a user identified by his UUID.',
)
...
@router.delete(
    ...
    description='Deletes a user identified by his UUID',
)
